...
$title = "Stok Masuk | Sistem Manajemen Stok Batik";
...
if (isset($_POST['simpan'])) {
    ...
    mysqli_query($conn, "INSERT INTO transaksi (kode_transaksi, tanggal_transaksi, jenis_transaksi, id_user, keterangan, total_harga)
                        VALUES ('$kode', '$tanggal', 'masuk', '$id_user', '$keterangan', '$total')");
    ...
    echo "<script>alert('Stok masuk berhasil disimpan!');window.location='data_transaksi.php';</script>";
}
?>

<h4><i class="fa-solid fa-boxes-packing me-2"></i>Tambah Stok Masuk</h4>
